...
**A modality-agnostic package that integrates ultrafast cross-modal alignment, unpaired/paired multimodal integration, and interactive 3D exploration for spatial omics data.**  
---
